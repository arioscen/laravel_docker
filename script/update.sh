...
sudo docker-compose exec php php /usr/share/nginx/html/laravel/artisan migrate
sudo docker-compose exec php php /usr/share/nginx/html/laravel/artisan db:seed
